...
|----|-------|-------|--------|------------|
| TASK-001 | Add Prettier + EditorConfig | SONNET-A | pending | — |
| TASK-002 | Add eslint-config-prettier | SONNET-A | pending | TASK-001 |
| TASK-003 | Add Husky + lint-staged | SONNET-A | pending | TASK-001 |
